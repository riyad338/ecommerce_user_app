...
class _PhoneAuthPageState extends State<PhoneAuthPage> {
  ...
  Future<void> verifyPhoneNumber(
    ...
    PhoneVerificationCompleted verificationCompleted =
      ...
      showMsg(context, "Verification Completed");
    };
    PhoneVerificationFailed verificationFailed =
        (FirebaseAuthException exception) {
      showMsg(context, exception.toString());
    };
    PhoneCodeSent codeSent = (String verificationID, [forceResnedingtoken]) {
      showMsg(context, "Verification Code sent on the phone number");
      setData(verificationID);
    };

    PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
        (String verificationID) {
      showMsg(context, "Time out");
    };
    try {
